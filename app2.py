...
TASKS = ['duty_dep_name', 'proc_type', 'keyword']
BEST_CHECKPOINT = ['1000', '2000', '1000']
...
def service():
    ...
    try:
        ...
        duty_dep_name_word, duty_dep_name_id = result_list[0][0], result_list[0][1] # [移网质量>>网络覆盖>>弱覆盖需优化解决>>弱覆盖需优化解决], [943fb1cb08bb4d3faf3047ab088e5b17_S2]
        proc_type_word, proc_type_id = result_list[1][0], result_list[1][1]
        keyword_word, keyword_id = result_list[2][0], result_list[2][1]
    ...
    return_data = {
        'duty_dep_name_id': duty_dep_name_id,
        'duty_dep_name_word': duty_dep_name_word,
        'proc_type_id': proc_type_id,
        'proc_type_word': proc_type_word,
