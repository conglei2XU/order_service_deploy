...
def service1():
    ...
    try:
        ...
        duty_reason_word, duty_reason_id = result_list[0][0], result_list[0][1]  # [移网质量>>网络覆盖>>弱覆盖需优化解决>>弱覆盖需优化解决], [943fb1cb08bb4d3faf3047ab088e5b17_S2]
        location_info_word, location_info_id = result_list[1][0], result_list[1][1]
    ...
    return_data = {
        'duty_reason_id': duty_reason_id,
        'location_info_id': location_info_id,
        'duty_reason_word': duty_reason_word,
        'location_info_word': location_info_word
    }
